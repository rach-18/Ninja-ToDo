...
function Tasks() {
    ...
    const sortedPriorities = Object.keys(tasks).sort((a, b) => priorityOrder[a] - priorityOrder[b]);

    return (
        <div className="w-full bg-[#F9FAFC] p-5 border-2 general-shadow rounded-lg border-blue-300">
